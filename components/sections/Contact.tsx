...
const contacts = [
  {
    label: 'GitHub',
    display: 'github.com/kranklee ↗',
    href: 'https://github.com/kranklee',
    Icon: GitHubIcon,
  },
  {
    label: 'Email',
    display: 'cem@cembesli.com ↗',
    href: 'mailto:cem@cembesli.com',
    Icon: EmailIcon,
  },
  {
    label: 'LinkedIn',
    display: 'linkedin.com/in/cembesli ↗',
        ...
        <div>
          {contacts.map(({ label, display, href, Icon }, i) => (
            <motion.a
              ...
              initial={{ opacity: 0, y: 24 }}
              animate={inView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.6, ease: [0.25, 0.1, 0.25, 1], delay: 0.16 + i * 0.12 }}
